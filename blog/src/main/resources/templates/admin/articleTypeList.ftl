<#include "../import/adminTop.ftl">
            ...
            <div class="panel col-sm-6">
                <div class="panel-body">
                    ...
                    <#if articleType0List?? && articleType0List?size gt 0 >
                        <div class="panel">
                            <div class="panel-body">
                                <button type="button" class="btn btn-success" onclick="addOrUpdateArticleType()">
                                    添加一级类型
                                </button>
                                <hr/>
                                <table class="table">
                                    ...
                                    <#list articleType0List as articleType>
                                        <tr>
                                            ...
                                            <td>
                                                ${(articleType.getArticleTypeAddTime())}
                                            </td>
                                            <td>
                                                <a href="/hzy2003/article/type/list?articleTypeParentId=${(articleType.articleTypeId)}">
    ...
    <script type="text/javascript">
        ...
        function articleUpdateAction() {
            ...
            $.post("/hzy2003/article/type/addOrUpdate", {
