...
<#if articleVoIPage?? && articleVoIPage.list?size gt 0>
    <form class="form-horizontal" action="/hzy2003/article/list" method="get">
        <div class="form-group">
            <label for="articleVoTitle" class="col-sm-1">文章标题</label>
            <div class="col-sm-3">
            ...
            <div class="col-sm-1">
                <a href="/hzy2003/article/list" class="btn btn-success"><i class="icon icon-search"></i> 搜索全部</a>
            </div>
        </div>
    </form>
    <div class="panel">
...
<script type="text/javascript">
    ...
    function getNewData(pageNumber) {
        ...
        window.location.href = "/hzy2003/article/list?pageNumber=" + pageNumber + "<#if (articleName?? && articleName?length>0)>&articleName=${articleName!}</#if>";
    }
