...
<div class="col-xs-12">
    <ol class="breadcrumb" style="margin-bottom: 5px;">
        ...
        <li class="active"><i class="icon-search"></i> ${topicTitle!}</li>
    </ol>
    <div class="panel">
        <div class="panel-body">
            <#if topicIPage?? && (topicIPage.list)?? && (topicIPage.list)?size gt 0 >
                <#list  topicIPage.list as topicVo>
                        ...
                        <div class="panel-body" style="padding: 0;">
                            <div class="col-sm-12" style="padding: 0;text-align: center;">
                                <ul class="pager" style="margin-top: 10px;margin-bottom: 10px;">
                                    ...
                                    <#if (topicIPage.pageNumber)?? && (topicIPage.pageNumber) lte 1>
                                        <li class="previous disabled">
                                            <a href="javascript:void(0)"><i class="icon-chevron-left"></i></a>
                                        </li>
                                    <#else>
                                        <li class="previous" onclick="getNewData('${topicIPage.pageNumber-1}')">
                                            <a href="javascript:void(0)"><i class="icon-chevron-left"></i></a>
                                        </li>
                                    </#if>
                                    <li>
                                        <a href="javascript:void(0)" class="btn">
                                            ${topicIPage.pageNumber}页/共${topicIPage.totalPage}</a>
                                    </li>
                                    <#if topicIPage.pageNumber gte topicIPage.totalPage>
                                        <li class="next disabled">
                                            <a href="javascript:void(0)"><i class="icon-chevron-right"></i></a>
                                        </li>
                                    <#else>
                                        <li class="next" onclick="getNewData('${topicIPage.pageNumber+1}')">
                                            <a href="javascript:void(0)"><i class="icon-chevron-right"></i></a>
                                        </li>
                                    </#if>
                                    <li class="previous" onclick="getNewData('${topicIPage.totalPage}')">
...
<script>
    function getNewData(pageNumber) {
        ...
        window.location.href = "/topic/search?pageNumber=" + pageNumber + "<#if topicTitle??>&topicTitle=${topicTitle!}</#if>";
    }
    ...
    function renderPage() {
        ...
        let totalPage = '${topicIPage.totalPage}';
