...
<div class="col-xs-12">
    <ol class="breadcrumb" style="margin-bottom: 5px;">
        ...
        <li class="active">${topicTagName!}</li>
    </ol>
    <div class="panel">
...
<script>
    function getNewData(pageNumber) {
        ...
        window.location.href = "/tag/topic/list?pageNumber=" + pageNumber + "<#if topicTagId?? && topicTagId?length gt 0>&topicTagId=${topicTagId!}</#if>";
    }
